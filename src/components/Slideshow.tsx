...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    icon: '✅',
    content: [
      'Upload any export control contract (PDF) — single page, instantly parsed',
  ...
  },
  {
    ...
    content: [
      ...
      'Confidence scores with visual progress bars per finding',
      'Accept/Reject toggle — auto-shows red/green diff on accept',
      'Side-by-side diff view: original crossed out in red, suggested rewrite in green',
  ...
  },
  {
    ...
    content: [
      ...
      '2. Click the ⚙ icon and paste your key',
      '3. Upload a mock contract from the repository (mock-data/pdfs/)',
